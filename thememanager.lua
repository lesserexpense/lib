...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['perk.lol'] 		= { 1, httpService:JSONDecode('{"FontColor":"e6e9ef","MainColor":"1f242d","AccentColor":"3b82f6","BackgroundColor":"181c23","OutlineColor":"323845"}') },
	...
	function ThemeManager:ThemeUpdate()
		...
		for _, field in next, THEME_FIELDS do
	...
	function ThemeManager:LoadDefault()		
		local theme = self.DefaultTheme or 'perk.lol'
	...
	function ThemeManager:GetCustomTheme(file)
		...
		if not isfile(path) and file:sub(-5) ~= '.json' then
			path = path .. '.json'
		end
